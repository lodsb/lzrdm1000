...
package trolltech.demos.imageviewer;

import com.trolltech.qt.core.*;
import com.trolltech.qt.gui.*;

public class Ui_AboutImageViewer
{
    ...
    {
        label.setText(com.trolltech.qt.core.QCoreApplication.translate("AboutImageViewer", ""));
...
"<li style=\" font-size:10pt;\" style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The overall power and flexibility of the Qt API.</li></ul></body></html>"));
        okButton.setText(com.trolltech.qt.core.QCoreApplication.translate("AboutImageViewer", "OK"));
    } // retranslateUi
