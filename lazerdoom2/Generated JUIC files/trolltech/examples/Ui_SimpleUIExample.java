...
public class Ui_SimpleUIExample
{
    ...
    {
        SimpleUIExample.setWindowTitle(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Dialog"));
        groupBox_Required.setTitle(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Required"));
        checkBox_Spam.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Send me SPAM"));
        label_Email.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "E-Mail"));
        label_Name.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Full Name"));
        groupBox_Optional.setTitle(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Optional"));
        label_Born.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Born"));
        label_Profession.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Profession"));
        label_What.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "What"));
        comboBox_Profession.clear();
        comboBox_Profession.addItem(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", ""));
        comboBox_Profession.addItem(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Superstar"));
        comboBox_Profession.addItem(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Programmer"));
        comboBox_Profession.addItem(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Teacher"));
        label_Comments.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Comments:"));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:'MS'; font-size:8pt;\">You can write some <span style=\" text-decoration: underline;\">comments</span> here.</p></body></html>"));
        pushButton_Clear.setText(com.trolltech.qt.core.QCoreApplication.translate("SimpleUIExample", "Clear comment"));
    } // retranslateUi
