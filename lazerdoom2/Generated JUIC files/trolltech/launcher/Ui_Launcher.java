...
public class Ui_Launcher
{
    ...
    {
        Launcher.setWindowTitle(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "Form"));
        group_main.setTitle(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "Qt Jambi Example and Demo Launcher"));
        groupBox.setTitle(com.trolltech.qt.core.QCoreApplication.translate("Launcher", ""));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:'MS Shell Dlg 2'; font-size:8pt; font-style:italic;\">No source</p></body></html>"));
        group_styles.setTitle(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "Styles"));
        button_documentation.setText(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "Documentation"));
        button_content.setText(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "View Source"));
        button_launch.setText(com.trolltech.qt.core.QCoreApplication.translate("Launcher", "Launch"));
    } // retranslateUi
